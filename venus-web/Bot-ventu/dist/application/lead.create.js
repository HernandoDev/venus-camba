...
class LeadCreate {
    ...
    sendMessageAndSave({ message, phone,url_imagen }) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log(' metodo sendMessageAndSave');
            const responseDbSave = yield this.leadRepository.save({ message, phone }); //TODO DB
            const responseExSave = yield this.leadExternal.sendMsg({ message, phone,url_imagen }); //TODO enviar a ws
